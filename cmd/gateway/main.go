...
func main() {
	...
	r.POST("/companies", middleware.Bind[middleware.Company], middleware.RequireOwnerAuth, companies.AddCompany)
	r.POST("/companies/:company_id/services", middleware.Bind[middleware.Service], middleware.RequireOwnerAuth, services.AddService)
	r.POST("/companies/:company_id/employees", middleware.Bind[middleware.Employee], middleware.RequireOwnerAuth, employees.AddEmployee)
	...
	r.PUT("/companies/:company_id", middleware.Bind[middleware.Company], middleware.RequireOwnerAuth, companies.UpdateCompany)
	r.PUT("/companies/:company_id/services/:service_id", middleware.Bind[middleware.Service], middleware.RequireOwnerAuth, services.UpdateService)
	r.PUT("/companies/:company_id/employees/:employee_id", middleware.Bind[middleware.Employee], middleware.RequireOwnerAuth, employees.UpdateEmployee)
	r.PUT("/customers", middleware.Bind[middleware.UserUpdate], middleware.RequireCustomerAuth, users.UpdateCustomer)
	r.PUT("/owners", middleware.Bind[middleware.UserUpdate], middleware.RequireOwnerAuth, users.UpdateOwner)
